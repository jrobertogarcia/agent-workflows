...
3. **Write the Message**: Follow the detected convention. Describe the outcome, not the process, and do not reference the prompt or the agent conversation that produced the change.
